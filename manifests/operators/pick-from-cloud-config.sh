...
# The base manifests/wireguard.yml assumes that your `bosh cloud-config` contains
...
#
# Usage:
#   bosh deploy manifests/wireguard.yml -o <(./manifests/operators/pick-from-cloud-config.sh)
